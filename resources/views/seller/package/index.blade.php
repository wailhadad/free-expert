...
@section('content')
          ...
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-lg-right float-left mr-2 d-none bulk-delete"
                data-href="{{ route('seller.service_management.service.bulk_delete_package') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('seller.service_management.service.delete_package', ['id' => $package->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('seller.package.create')

  {{-- edit modal --}}
  @include('seller.package.edit')
@endsection
