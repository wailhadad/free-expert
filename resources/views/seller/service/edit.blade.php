      ...
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block"
            href="{{ route('seller.service_management.services', ['language' => $defaultLang->code]) }}">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="serviceForm"
                action="{{ route('seller.service_management.update_service', ['id' => $service->id]) }}"
...
@section('script')
  <script>
    ...
    const imgDetachUrl = "{{ route('seller.service_management.detach_slider_image') }}";
  </script>
