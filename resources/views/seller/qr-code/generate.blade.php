...
@section('content')
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="url" class="form-control" name="url" value="{{ $bs->qr_url }}"
                    onchange="generateQR()">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control jscolor" name="color" value="{{ $bs->qr_color }}"
                    onchange="generateQR()">
                  <p class="mt-1 mb-0 text-warning">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="size" min="200" max="350"
                    value="{{ $bs->qr_size }}" onchange="generateQR()">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="margin" min="0" max="5"
                    value="{{ $bs->qr_margin }}" onchange="generateQR()">
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    ...
                    @else
                      <img src="{{ asset('assets/img/qr-codes/' . $bs->qr_inserted_image) }}" alt="inserted image"
                        class="uploaded-img">
                    @endif
                  </div>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="image_size" min="1" max="20"
                    value="{{ $bs->qr_inserted_image_size }}" onchange="generateQR()">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="img_x_pos" min="0" max="100"
                    value="{{ $bs->qr_inserted_image_x }}" onchange="generateQR()">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="img_y_pos" min="0" max="100"
                    value="{{ $bs->qr_inserted_image_y }}" onchange="generateQR()">
            ...
            <div class="row qrcode-type" id="text-type">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="text" value="{{ $bs->qr_text }}"
                    onchange="generateQR()">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control jscolor" name="text_color"
                    value="{{ $bs->qr_text_color }}" onchange="generateQR()">
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="text_size" min="1" max="15"
                    value="{{ $bs->qr_text_size }}" onchange="generateQR()">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="txt_x_pos" min="0" max="100"
                    value="{{ $bs->qr_text_x }}" onchange="generateQR()">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="txt_y_pos" min="0" max="100"
                    value="{{ $bs->qr_text_y }}" onchange="generateQR()">
      ...
      <div class="card bg-white">
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-8">
              <form action="{{ route('seller.qr_codes.clear') }}" method="post"
              ...
              <a href="#" data-toggle="modal" data-target="#saveModal"
                class="btn btn-success btn-sm float-lg-right float-left mr-2">{{ __('Save') }}</a>
            </div>
          </div>
        </div>
        ...
        <div class="card-footer text-center">
          <a href="{{ asset('assets/img/qr-codes/' . $bs->qr_image) }}" class="btn btn-primary btn-sm"
  ...
  {{-- save modal --}}
  @includeIf('seller.qr-code.save')
@endsection

@section('script')
  <script>
    let regenerateUrl = "{{ route('seller.qr_codes.regenerate_code') }}";
  </script>
