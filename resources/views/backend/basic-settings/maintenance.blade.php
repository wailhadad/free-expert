            ...
            <div class="col-lg-6 offset-lg-3">
              <form id="maintenanceForm" action="{{ route('admin.basic_settings.update_maintenance_mode') }}"
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="maintenance_msg" rows="3" cols="80">{{ !empty($data) ? $data->maintenance_msg : '' }}</textarea>
                ...
                <div class="form-group">
                  ...
                  <p class="mt-2 mb-0 text-warning">
                    {{ '*' . __('During maintenance, you can access the system by using this token.') }}<br>
                    <span class="text-info">{{ url('/') }}/token-value</span><br>
