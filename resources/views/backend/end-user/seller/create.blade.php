...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Add Seller') }}</h4>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-12">
              <div class="card-title">{{ __('Add Seller') }}</div>
            </div>
          </div>
        </div>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-10 mx-auto">
              <form id="ajaxEditForm" action="{{ route('admin.seller_management.save-seller') }}" method="post">
                @csrf
                <div class="row">
                  <div class="col-lg-12">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                ...
                                <p id="editErr_{{ $language->code }}_skills" class="mt-1 mb-0 text-danger em"></p>
                              </div>
                            </div>
                            <div class="col-lg-4">
                              <div class="form-group">
