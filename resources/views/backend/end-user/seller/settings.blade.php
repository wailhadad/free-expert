        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 mx-auto">
              <form id="ajaxEditForm" action="{{ route('admin.seller_management.setting.update') }}" method="post">
                @csrf
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <div class="custom-control custom-checkbox seller_admin_approvalbtn">
                        <input type="checkbox" {{ $setting->seller_admin_approval == 1 ? 'checked' : '' }}
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" {{ $setting->seller_email_verification == 1 ? 'checked' : '' }}
