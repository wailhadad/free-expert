...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a
          href="{{ route('admin.service_management.services', ['language' => $defaultLang->code]) }}">{{ __('Service') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-lg-right float-left mr-2 d-none bulk-delete"
                data-href="{{ route('admin.service_management.service.bulk_delete_faq') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.service_management.service.delete_faq', ['id' => $faq->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('backend.client-service.faq.create')

  {{-- edit modal --}}
  @include('backend.client-service.faq.edit')
@endsection
