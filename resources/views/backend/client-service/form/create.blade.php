  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="{{ route('admin.service_management.store_form') }}"
          method="post">
          @csrf
          ...
          <div class="form-group">
            <label for="">{{ __('Seller') }}</label>
            <select name="seller_id" class="select2">
              <option selected value="">{{ __('Select a Seller') }}</option>
