...
class SocialiteController extends Controller
{
    ...
    {
        // Set session variable to indicate this is a user login
        Session::put('google_auth_type', 'user');
    ...
    public function googleAuthentication()
    {
        try {
            ...
            $authType = Session::get('google_auth_type', 'user');
            
            // Clear the session variable
            Session::forget('google_auth_type');
            
            if ($authType === 'seller') {
                return $this->handleSellerAuthentication($googleUser);
            } else {
    ...
    private function handleSellerAuthentication($googleUser)
    {
